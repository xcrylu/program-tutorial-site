...
VALUES (1, '<h2>Python 环境设置</h2>
<p>学习 Python 编程的第一步，是搭建稳定的开发环境。Python 作为解释型语言，核心依赖「Python 解释器」，搭配合适的编辑器即可完成开发。</p>

<h3>1. 下载 Python 解释器</h3>
<p>访问 <a href="https://www.python.org/downloads/" target="_blank">Python 官网</a>，根据操作系统选择对应版本（推荐 Python 3.10+）。</p>
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role_id` INT NOT NULL DEFAULT 2 COMMENT '角色ID，默认普通用户',
  `avatar` VARCHAR(200) DEFAULT 'default-avatar.png' COMMENT '头像路径',
